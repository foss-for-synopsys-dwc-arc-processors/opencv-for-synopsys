...
protected:
    void run(int)
    {
        ...
        for( int idx = 0; idx < test_case_count; idx++ )
        {
            ...
            int sz[] = {(int)cvtest::randInt(rng)%10+1, (int)cvtest::randInt(rng)%10+1, (int)cvtest::randInt(rng)%10+1};
            ...
            int ssz[] = {(int)cvtest::randInt(rng)%10+1, (int)cvtest::randInt(rng)%10+1,
                (int)cvtest::randInt(rng)%10+1,(int)cvtest::randInt(rng)%10+1};
